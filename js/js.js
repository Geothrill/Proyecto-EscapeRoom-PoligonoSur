        ...
        $('input[type=radio][name=opciones]').change(function() {
          if (this.value == item[1].correcta) {
            ...
            if(contadorItem==1){
              ...
              $('#opciones-pc').empty();
              $('#preguntas-pc').empty();
              $('#preguntas-pc').text("ENHORABUENA!!! HAS CONSEGUIDO FINALIZAR A TIEMPO!!! \n TIEMPO RESTANTE: "+tiempo);
              $('#tituloPopup').append($('<input type="button" class="btn btn-primary start" onclick="location.reload()" id="comenzar" name="comenzar" value="Volver a jugar"></input><br/><br/> <img id="gameover" src="images/win.png"> '));
            }else{
              console.log("ok");
              $('#opciones-pc').empty();
              $('#preguntas-pc').empty();
        ...
        $("#vida"+errores).hide();
          if(errores==3){
            ...
            if(contadorItem==1){
              ...
              $('#preguntas-pc').empty();
              $('#preguntas-pc').text("ENHORABUENA!!! HAS CONSEGUIDO FINALIZAR A TIEMPO!!! \n TIEMPO RESTANTE: "+tiempo);
              $('#tituloPopup').append($('<input type="button" class="btn btn-primary start" id="comenzar" onclick="location.reload()" name="comenzar" value="Volver a jugar"></input><br/><br/> <img id="gameover" src="images/win.png">'));
            }else{
              console.log("ok");
              $('#opciones-pc').empty();
              $('#preguntas-pc').empty();
              ...
              setTimeout( function () {
                ...
                $('#preguntas-pc').empty();
                $('#opciones-pc').append($('<p> TE QUEDASTE SIN VIDAS </p>'));
                $('#tituloPopup').append($('<input type="button" class="btn btn-primary start comenzar" id="comenzar" name="comenzar" onclick="location.reload()" value="Volver a jugar"></input><br/><br/>'));
